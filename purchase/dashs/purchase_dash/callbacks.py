...
def plot_figure(selected_products, selected_warehouses, selected_categories, selected_suppliers, start_date, end_date, n_clicks, value_acceptable, value_risque):
    ...
    if n_clicks > 0 and value_acceptable != None and value_risque != None:
        ...
        df_order_detail_filtred = df_order_detail_filtred.apply(
            lambda x: count_values(x, value_acceptable, value_risque), axis=1)
        ...
        labels = ['0<valeur<'+str(value_acceptable), str(value_acceptable) +
                  '<value<'+str(value_risque), str(value_risque)+'<value']
    ...
    if df_order_detail_filtred.size != 0:
        ...
        figure.add_trace(go.Scatter(
            x=[df_order_detail_filtred[df_order_detail_filtred['diff_days'] ==
                                       df_order_detail_filtred['diff_days'].min()].index.tolist()[0]],
        ...
        figure.add_trace(go.Scatter(
            x=[df_order_detail_filtred[df_order_detail_filtred['diff_days'] ==
                                       df_order_detail_filtred['diff_days'].max()].index.tolist()[0]],
        ...
        figure.add_trace(go.Scatter(
            ...
            y=[df_order_detail_filtred['diff_days'].mean(
            ), df_order_detail_filtred['diff_days'].mean()],
            mode="lines",
            showlegend=True,
