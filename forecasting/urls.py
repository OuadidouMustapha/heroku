...
urlpatterns = [
    ...
    path('forecast/v<int:version_id>/update-quantity',
         views.updateQuantity, name='ajax_update_forecast_qty'),
    path('forecast/v<int:version_id>/add-quantity',
         views.addQuantity, name='ajax_add_forecast_qty'),
    path('forecast/v<int:version_id>/add-forecast',
         views.addForecast, name='ajax_add_forecast'),
